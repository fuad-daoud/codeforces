defmodule CodeforcesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CodeforcesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CodeforcesWeb.Gettext, "errors", msg, opts)
    end
  end
